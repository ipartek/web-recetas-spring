...
import com.ipartek.formacion.ws.client.mapper.ProvinciaMapperDOM;
import com.ipartek.formacion.ws.client.mapper.ProvinciaMapperSplit;
import com.ipartek.formacion.ws.client.mapper.ProvinciasMapperJaxb;

public class OficinasBuzonesTest {

	
	/*
	    RESPONSE por si No funciona el WebService
	...
	*/
	...
	@Test
	public void testConsultaProvinciasSplit() {
	...
	public void testConsultaProvinciasDOM() {
		...
		//convertir String => ArrayList<Provincia>
		MapperProvincia mapper = new  ProvinciaMapperDOM();
		ArrayList<Provincia> provincias = mapper.parse(xmlProvincias);
	...
	@Test
	public void testConsultaProvinciasJaxb() {
		...
		//convertir String => ArrayList<Provincia>
		MapperProvincia mapper = new  ProvinciasMapperJaxb();
		ArrayList<Provincia> provincias = mapper.parse(xmlProvincias);
