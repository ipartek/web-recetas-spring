...
<c:forEach items="${receta.ingredientes}" var="ingrediente">
	<li id="ingrediente${ingrediente.id}">
		...
		<span style="color:red;">
			<button type="button" class="btn btn-default" title="Botón para eliminar ingrediente ${ingrediente.nombre}" onclick="show_modal_eliminar_ingrediente(${ingrediente.id},'${ingrediente.nombre}')">
