...
<div class="col-md-6">
	<form:form action="usuario/crear" modelAttribute="usuario">
		...
		<form:input id="nombreUsuario" path="nombre" placeholder="Nombre Usuario"/><br>
		<p id="msgNombreUsuario"></p>	
		<form:errors path="nombre" cssStyle="color:red;"/><br>
	
		<form:input path="email" value="${usuario.email}" placeholder="Email"/><br><br>
