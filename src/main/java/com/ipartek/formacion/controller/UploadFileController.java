...
public class UploadFileController  /*implements HandlerExceptionResolver*/ {
	...
	public String uploadFileHandler(@RequestParam("imagen") MultipartFile file, Model model, @RequestParam("id") int id)
		...
		try {
			...
			if (!file.isEmpty()) {
				...
				serviceReceta.insertImagen(img);
		...
		return "redirect:/receta/edit/"+ id;
	}
